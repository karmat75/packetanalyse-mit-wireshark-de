...
## Was dich hier bewusst nicht erwartet

- keine Exam Dumps
- keine echten Zertifizierungsfragen
- keine geschützten Trainingsinhalte Dritter

Der Fokus liegt auf echter Analysepraxis, die dir auch außerhalb einer Prüfung hilft.

!!! warning "Nur mit Berechtigung mitschneiden"
    Paketmitschnitte sind nur in Netzen erlaubt, für die du eine ausdrückliche Erlaubnis hast.

## Projektstatus

Der Kurs wächst kontinuierlich. Inhalte werden laufend erweitert, Labs verfeinert und Quiz-/Challenge-Bereiche ausgebaut.

Wenn du beitragen möchtest: [Beitragen und Review](90-referenz/beitragen-und-review.md).